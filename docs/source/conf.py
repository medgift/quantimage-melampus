...
#sys.path.insert(0, os.path.abspath('/home/orfeas/PycharmProjects/melampus/melampus/'))


# -- Project information -----------------------------------------------------

project = 'melampus'
copyright = '2020, Orfeas Aidonopoulos'
...
man_pages = [
    (master_doc, 'melampus', 'melampus Documentation',
     [author], 1)
]
